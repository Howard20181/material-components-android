...
public class BlurBehindDialogBuilder extends MaterialAlertDialogBuilder {
  ...
  private static final String TAG = "MDCTheming";
...
//        window.setBackgroundDrawable(new ColorDrawable(0));//Color.TRANSPARENT
//        window.setBackgroundBlurRadius(55);// R.styleable.Window_windowBackgroundBlurRadius
